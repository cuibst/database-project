...
//            log.info("yes");
    ...
    public void removeTable(String name) {
        if (!this.tbMap.containsKey(name))
            throw new RuntimeException(String.format("Can not find table named :{}", name));
    ...
    public void createIndex(String indexName, String tbName, String colName) {
        if (this.index.containsKey(indexName))
            throw new RuntimeException(String.format("Index named :{} already exits", indexName));
    ...
    public void removeIndex(String name) {
        if (!this.index.containsKey(name))
            throw new RuntimeException(String.format("Can not find index named :{}", name));
